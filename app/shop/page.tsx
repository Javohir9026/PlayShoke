  ...
  return (
    <div className="container mb-10 mt-10">
      ...
      <div className="grid grid-cols-4 gap-5">
        {Premiums.map((item) => (
          <Link href={`/shop/premium/${item.id}`} key={item.id} className="border-2 px-4 py-4 border-red-500 rounded-[20px] flex flex-col gap-3 group hover:bg-red-900/20 cursor-pointer">
